...
-- you can remove any of the additional fields that are not required by your action.
	...
	newaction 
	{
		...
		-- premake.actions.clean.file() and premake.actions.clean.directory() are convenience functions
		-- that use the same pattern matching as premake.generate() above.

		oncleansolution = function(sln)
			clean.file(sln, "%%.sln.txt")
		end,
		
		oncleanproject  = function(prj)
			if premake.isdotnetproject(prj) then
				clean.file(prj, "%%.csprj.txt")
			else
				clean.file(prj, "%%.cprj.txt")
			end
		end,
